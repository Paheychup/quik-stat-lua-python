...
function OnInit()
	...
	--filename="IPADDRESS_"..tostring(getInfoParam("IPADDRESS")).."_UID_"..tostring(getInfoParam("USERID")).."_"..tostring(os.date("%Y%m%d")).."_"..tostring(timeformat(getInfoParam("LOCALTIME"))).."_FR.txt"
	filename=tostring(getInfoParam("IPCOMMENT")).."_IPADDRESS_"..tostring(getInfoParam("IPADDRESS")).."_UID_"..tostring(getInfoParam("USERID")).."_"..tostring(os.date("%Y%m%d")).."_"..tostring(timeformat(getInfoParam("LOCALTIME"))).."_FR.txt"
	trans_send_order=0
	trans_kill_order=0
	stop_flag=0
...
function OnTransReply(trans_reply)
	...
	if trans_send_order==1 and trans_kill_order==0 then
		...
		elseif status==3 then
			...
			message_send_order=("send_order;"..trans_id_ord..";"..tostring(local_time)..";"..order_num..";"..tostring(send_order_stop_time)..";"..tostring(send_order_start_time)..";"..tostring(send_order_stop_time-send_order_start_time)..";FR;"..tostring(os.date("%Y%m%d")).."\n")
	...
	elseif trans_kill_order==1 and trans_send_order==1  then
		...
		elseif status==3 then
			...
			message_kill_order=("kill_order;"..trans_id_ord..";"..tostring(local_time)..";"..order_num..";"..tostring(kill_order_stop_time)..";"..tostring(kill_order_start_time)..";"..tostring(kill_order_stop_time-kill_order_start_time)..";FR;"..tostring(os.date("%Y%m%d")).."\n")
			trans_send_order=0 
			trans_kill_order=0
